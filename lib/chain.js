...
export const publicClient = createPublicClient({
  chain: CHAIN,
  transport: http(RPC_URL || (CHAIN_ID === 8453 ? 'https://mainnet.base.org' : 'https://sepolia.base.org'))
});
...
export function getWalletClient() {
  ...
  walletClient = createWalletClient({ account, chain: CHAIN, transport: http(RPC_URL || (CHAIN_ID === 8453 ? 'https://mainnet.base.org' : 'https://sepolia.base.org')) });
  return walletClient;
}
